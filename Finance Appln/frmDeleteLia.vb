...
Public Class frmDeleteLia
    Dim cn As New SqlConnection
    Dim cmd As New SqlCommand
    Dim rs As SqlDataReader
    Dim ds As New DataSet1
    Private Sub frmDeleteLia_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        cn.ConnectionString = "Data Source=NIKUL-LAPTOP;Initial Catalog=ColorGrid;Integrated Security=True"
        cn.Open()
        cmd.Connection = cn
        cmd.CommandText = "select LID from Liablities"
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox1.SelectedIndexChanged
        If (ComboBox1.SelectedIndex <> -1) Then
            cn.Open()
            cmd.Connection = cn
            cmd.CommandText = "select * from Liablities where LID='" + ComboBox1.SelectedItem.ToString() + "'"
            rs = cmd.ExecuteReader()
            While (rs.Read())
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        If (ans = Windows.Forms.DialogResult.Yes) Then
            cn.Open()
            cmd.Connection = cn
            cmd.CommandText = "delete from Liablities where LID='" + ComboBox1.SelectedItem.ToString() + "'"
            cmd.ExecuteNonQuery()
            cmd.Dispose()
            cn.Close()
